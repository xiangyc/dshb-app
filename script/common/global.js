(function(window) {
	...
	var qaBalance = "QaBalance";

	//var requestUri = "http://192.168.4.55:8061/api/v1";
	var requestUri = "http://120.79.197.150:8081/api/v1";
	var domain = "http://120.79.197.150:8081"
	var shareUri = 'http://120.79.197.150:8081';

//	var requestUri = "http://192.168.4.53:8061/api/v1";
//	var domain = "http://192.168.4.53:8061"
//	var shareUri = 'http://192.168.4.53:8061';


	//var requestUri = "http://192.168.4.34:8061/api/v1";
	//var domain = "http://192.168.4.34:8061"
	//var shareUri = 'http://192.168.4.34:8061';
	...
	g.getQaBalance = function() {
		return $api.getStorage(qaBalance);
	}

	g.setQaBalance = function(value) {
		$api.setStorage(qaBalance, value);
	}
